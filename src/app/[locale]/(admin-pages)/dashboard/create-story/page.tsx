...
export default async function CreateStory(props: { params: Promise<{ locale: Locale }> }) {
    ...
    return (
        <div className="flex w-full flex-col px-8">
            <h1 className="heading-3 py-8">{title.createStory}</h1>
            <div className="w-full py-12 lg:w-2xl">
                <CreateStoryForm countries={countries} locale={locale} activities={activityTypes} />
            </div>
        </div>
    );
}
